...
{\color{incolor}In [{\color{incolor} }]:} \PY{c}{\PYZsh{} Ejemplo de como bajar un archivo.}
        \PY{n}{download}\PY{p}{(}
            ...
            \PY{n}{pwd}\PY{p}{(}\PY{p}{)} \PY{o}{*} \PY{l+s}{\PYZdq{}}\PY{l+s}{/}\PY{l+s}{\PYZdq{}} \PY{o}{*} \PY{l+s}{\PYZdq{}}\PY{l+s}{m}\PY{l+s}{e}\PY{l+s}{d}\PY{l+s}{i}\PY{l+s}{c}\PY{l+s}{i}\PY{l+s}{o}\PY{l+s}{n}\PY{l+s}{e}\PY{l+s}{s}\PY{l+s}{1}\PY{l+s}{\PYZhy{}}\PY{l+s}{c}\PY{l+s}{1}\PY{l+s}{\PYZhy{}}\PY{l+s}{g}\PY{l+s}{6}\PY{l+s}{.}\PY{l+s}{d}\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{\PYZdq{}} \PY{c}{\PYZsh{} Guardamos pos.dat en un archivo llamado mediciones1\PYZhy{}c1\PYZhy{}g6.dat en el directorio local.}
        \PY{p}{)}
\end{Verbatim}
...
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Tenga en cuenta que en Windows debe cambiar \texttt{"/"} por
  \texttt{"\textbackslash{}"}!}
\item
